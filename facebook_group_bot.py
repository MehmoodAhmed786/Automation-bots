...
def scrape_facebook_group_members(facebook_email, facebook_password, group_url, csv_file="facebook_group_members.csv"):
...
if __name__ == "__main__":
    scrape_facebook_group_members("your_email@example.com", "your_password", "your_group_url")
